<template>
  <div class="layout-app-shell min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center">
            <div class="hidden md:flex items-center space-x-4">
              <NuxtLink to="/" class="text-gray-600 hover:text-gray-900 dark:text-gray-200 hover:dark:text-white">
                Dashboard</NuxtLink>
