<template>
  <UiCard class="ui-progress-chart">
    <h3 class="text-md font-medium text-gray-900 dark:text-gray-200 mb-4">Workouts Per Week</h3>
    <div class="grid grid-cols-7 gap-2">
      <div v-for="bar in bars" :key="bar.label">
        ...
        <p class="text-xs text-gray-600 dark:text-gray-200 mt-1 text-center">{{ bar.label }}</p>
      </div>
    </div>
  </UiCard>
</template>
